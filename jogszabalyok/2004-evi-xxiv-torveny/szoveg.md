...
- 32. gáz- és riasztófegyver: olyan eszköz, amely rendeltetésszerűen csak gáztöltény vagy riasztótöltény működtetésére alkalmas, feltéve, hogy
  ...
  - c) – a saját töltényűrrel rendelkező darabok esetében – ca) viselését a 3. § (1) bekezdés d) pontja szerint engedélyezték, cb) 2023. január 1. napját megelőzően gáz- és riasztófegyverként jogszerűen forgalomba hozták, vagy cc) megfelel a 2. mellékletben meghatározott követelményeknek;
...
- e) a d) pontban meghatározott szabálysértés miatt szabálysértési eljárás hatálya alatt áll,
- f) az engedély kiadására vonatkozó kérelmében valótlan adatot közöl, a kérelemmel összefüggő valós adatot elhallgat vagy a fegyverre, lőszerre (töltényre) lőszerelemre, lőtérre vonatkozó, jogszabályban meghatározott kötelezettségét súlyosan megszegi, a kérelem benyújtását vagy – ha ezen ok miatt az engedély visszavonása iránt eljárás indul – az engedély visszavonásáról szóló döntés véglegessé válását követő hat hónapig.
...
- b) a (2) bekezdés d) és e) pontjában meghatározott körülmény vizsgálata céljából a szabálysértési nyilvántartásból a (2) bekezdés d) és e) pontjában
...
- b) annak a természetes személynek engedélyezhető, aki megfelel a 3/A. § (1) bekezdés a) és b) pontjában meghatározott feltételnek, és akivel szemben nem áll fenn a 3/A. § (2) bekezdés a), b) vagy c) pontjában meghatározott körülmény.
...
- c) a szabálysértésekről, a szabálysértési eljárásról és a szabálysértési nyilvántartási rendszerről szóló törvényben meghatározottak szerint a 3/A. § (2) bekezdés d) és e) pontjában
...
(3) A lőfegyverek központi nyilvántartásából a rendőrség nemzetközi bűnügyi együttműködési központja, illetve Magyarország nemzetközi szerződésben adattovábbításra feljogosított más szerve az (1) bekezdés c) pontjában felsoroltak részére adatszolgáltatás teljesítése céljából az adatok átvételére és továbbítására jogosult.
...
(2) A lőfegyver-kereskedő tevékenységének befejezésekor köteles a 12. § (2) bekezdésében és a 15. §-ban foglalt nyilvántartását 5. § (1) bekezdésében meghatározott szervnek átadni.
