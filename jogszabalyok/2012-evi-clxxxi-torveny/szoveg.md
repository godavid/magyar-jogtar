...
- b) a 6. § (2) és (3) bekezdése szerinti adatokat, valamint
- c) a (2) és (3) bekezdés szerinti adatokat.
...
(2) A megjelölés SIS-be történő felvétele érdekében a SIRENE Iroda megjelölni kívánt figyelmeztető jelzést elhelyező állam SIRENE Irodáját keresi meg.
