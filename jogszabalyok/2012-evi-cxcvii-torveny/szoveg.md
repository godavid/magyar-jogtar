...
| Sor- szám | 1. | 2. | 3. | 4. | 5. |
| --- | --- | --- | --- | --- | --- |
| Kölcsönzött munkavállaló neve | A kölcsönzés időszaka | Társadalom- biztosítási azonosító jel | A bér és végkielégítés együttes | A támogatásnak a Nemzeti Foglalkoztatási Alap bérgarancia alaprészéből igényelhető összege |
| 1. |  |  |  |  |  |
| 2. |  |  |  |  |  |
| 3. |  |  |  |  |  |
| 4. |  |  |  |  |  |
