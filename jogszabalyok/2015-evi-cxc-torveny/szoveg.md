...
Mivel az Egyezményt aláíró vagy annak aláírására irányuló szándékát kinyilvánító ország csak akkor válik az ezen Megállapodás 1. cikkének értelmében meghatározott Joghatósággá, ha az Egyezmény Részes felévé vált;
...
I. RÉSZ: ÁLTALÁNOS JELENTÉSTÉTELI KÖVETELMÉNYEK
...
II. RÉSZ: ÁLTALÁNOS ÁTVILÁGÍTÁSI KÖVETELMÉNYEK
...
III. RÉSZ: MEGLÉVŐ EGYÉNI SZÁMLÁK ÁTVILÁGÍTÁSA
...
IV. RÉSZ: ÚJ EGYÉNI SZÁMLÁK ÁTVILÁGÍTÁSA
...
V. RÉSZ: MEGLÉVŐ JOGALANYI SZÁMLÁK ÁTVILÁGÍTÁSA
...
VI. RÉSZ: ÚJ JOGALANYI SZÁMLÁK ÁTVILÁGÍTÁSA
...
VII. RÉSZ: KÜLÖNÖS ÁTVILÁGÍTÁSI SZABÁLYOK
...
VIII. RÉSZ: FOGALOMMEGHATÁROZÁSOK
...
A „Pénzügyi Számla” kifejezés nem foglalja magában a Kizárt Számlának minősülő számlát.
...
(iv) a számla nem értékpapír-hitelszámla vagy Pénzügyi Eszköz eladásával vagy cseréjével összefüggésben létrehozott hasonló számla; és (v) a számla nincs kapcsolatban a C(17)(f) albekezdésben írt számlával.
