...
### IX. Fejezet — EGYES PÉNZÜGYI ÉS GAZDASÁGI TÁRGYÚ, VALAMINT KÖZSZOLGÁLATTAL ÖSSZEFÜGGŐ TÖRVÉNYEK MÓDOSÍTÁSA
...
- 10. A Ctv. 2. számú melléklet II.1. a) pont ad) alpontja helyébe a következő rendelkezés lép: [II. Ha a bejegyzési (változásbejegyzési) kérelem tartalmára tekintettel kötelező, az egyes cégformák bejegyzéséhez (változásbejegyzéséhez) szükséges további okiratok:
...
- 2. A Bit. 4. számú melléklet 3. pont 3.4. alpontja helyébe a következő rendelkezés lép: (A biztosítási termékekhez olyan terméktervet kell készíteni, amely a következőket tartalmazza:
